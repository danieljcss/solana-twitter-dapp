...
<template>
  <div v-if="connected" class="px-8 py-4 border-b border-b-neutral-700">
    <!-- Content field. -->
    <textarea
      ref="textarea"
      rows="1"
      class="text-xl w-full bg-neutral-900 text-white focus:outline-none resize-none mb-3"
    ...
    <div class="flex flex-wrap items-center justify-between -m-2">
      ...
      <div class="relative m-2 mr-4">
        <input
          type="text"
          placeholder="topic"
          class="text-spink border border-white/20 focus:outline-none focus:border-white/80 focus:ring-1 focus:ring-spink/80 rounded-full pl-10 pr-4 py-2 bg-neutral-800"
        ...
        <div class="absolute left-0 inset-y-0 flex pl-3 pr-2">
          <svg
            ...
            :class="effectiveTopic ? 'text-spink' : 'text-neutral-400'"
            viewBox="0 0 20 20"
            fill="currentColor"
          >
            <path
      ...
      <div class="flex items-center space-x-6 m-2 ml-auto">
        ...
        <button
          ...
          :disabled="!canTweet"
          :class="canTweet ? 'bg-spink' : 'bg-wspink cursor-not-allowed'"
          @click="send"
        >
          Tweet
        </button>
  ...
  <div
    v-else
    class="px-8 py-4 bg-neutral-800 text-neutral-400 text-center border-b border-b-neutral-700"
  >
