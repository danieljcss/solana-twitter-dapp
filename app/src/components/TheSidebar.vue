  ...
  >
    ...
    <div class="flex flex-col items-center md:items-stretch space-y-2">
      ...
      >
        ...
        <div class="text-xl text-white hidden md:block">Home</div>
      </router-link>
      <router-link
        :to="{ name: 'Topics' }"
        class="rounded-full hover:bg-neutral-800 p-3 md:w-full inline-flex items-center space-x-4"
      ...
      >
        ...
        <div class="text-xl text-white hidden md:block">Topics</div>
      </router-link>
      <router-link
        :to="{ name: 'Users' }"
        class="rounded-full hover:bg-neutral-800 p-3 md:w-full inline-flex items-center space-x-4"
      ...
      >
        ...
        <div class="text-xl text-white hidden md:block">Profile</div>
      </router-link>
    </div>
